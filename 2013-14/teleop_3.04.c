...
#pragma config(Motor,  mtr_S1_C2_1,     DRIVE_NE,      tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S1_C2_2,     DRIVE_SE,      tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S1_C4_1,     DRIVE_SW,      tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S1_C4_2,     DRIVE_NW,      tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S2_C1_1,     FLAG,          tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S2_C1_2,     LIFT,          tmotorTetrix, openLoop)
#pragma config(Servo,  srvo_S1_C3_1,    FLAG_SERVO,           tServoContinuousRotation)
...
task main()
{
	...
	while (true)
	{
		...
		//	servo[FLAG_SERVO]=175;
		//}
		//else	if (joystick.joy2_Buttons & button3){ //B
		//	servo[FLAG_SERVO]=75;
		//}
		//else{
		//	servo[FLAG_SERVO]=127;
		//}
	...
	if (joystick.joy2_Buttons & button2){ //A
		nMotorEncoderTarget[WRIST] = ((armVal - startingArmPos)*5+startingWristPos);
		motor[WRIST] = 30;
	}
	else{
